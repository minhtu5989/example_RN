...
@inject('authStore')
@observer
class renderAddressList extends Component {
    constructor(props) {
        super(props);
...

                    {
                        ...
                        <SwipeListView
                            ...
                            renderHiddenItem={ (data, rowMap) => (
                                <View style={styles.rowBack}>
                                    <Text>Left</Text>
                                    <TouchableOpacity style={[styles.backRightBtn, styles.backRightBtnLeft]} onPress={ () => this.closeRow(rowMap, data.item.key) }>
                                        <Text style={styles.backTextWhite}>Close</Text>
                                    </TouchableOpacity>
                        ...
                        <SwipeListView
                            ...
                            renderHiddenItem={ (data, rowMap) => (
                                <View style={styles.rowBack}>
                                    ...
                                    <TouchableOpacity style={[styles.backRightBtn, styles.backRightBtnRight]} onPress={ () => this.deleteSectionRow(rowMap, data.item.key) }>
                                        <Text style={styles.backTextWhite}>Delete</Text>
                                    </TouchableOpacity>
                                </View>
                            )}
